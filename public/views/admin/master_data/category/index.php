...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><button onclick="goBack()"><span class="fa fa-arrow-circle-o-left"></span></button> Category <a href="<?=root()?>/admin/master_data/category/create" class="btn btn-primary"><i class="fa fa-plus"></i></a></h2>
        </div>
        <!-- END PAGE TITLE -->
                        ...
                        <div class="panel-body">
                            <table id="customers2" class="table datatable">
                                ...
                                <tr id="<?=$item->id?>">
                                    ...
                                    <td>
                                        <a href="<?=root()?>/admin/master_data/category/edit/<?=$item->id?>" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
                                        <button class="btn btn-danger btn-rounded btn-sm" onClick="delete_row(<?=$item->id?>, '<?=root().'/admin/master_data/category/destroy/'.$item->id?>')"><span class="fa fa-times"></span></button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
