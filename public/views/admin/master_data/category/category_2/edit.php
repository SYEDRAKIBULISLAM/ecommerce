...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><button onclick="goBack()"><span class="fa fa-arrow-circle-o-left"></span></button> Category 2 Edit</h2>
        </div>
        <!-- END PAGE TITLE -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="block">
                        ...
                        <form id="jvalidate" role="form" method="post" class="form-horizontal" action="<?=root()?>/admin/master_data/category/category_2/update/<?=$data['category2']->id?>">
                            <input type="hidden" name="user_id" value="<?=$_SESSION['userid'];?>">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Category Name *</label>
                                    <div class="col-md-9">
                                        <select class="form-control select" data-live-search="true" name="category_id" required>
                                            <option value="">Select Category</option>
                                            <?php

                                            foreach ($data['categories'] as $item)
                                            {
                                                if($item->id == $data['category2']->category->id)
                                                {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?=$data['category2']->name;?>" name="name" placeholder="Enter Category 2 name"/>
