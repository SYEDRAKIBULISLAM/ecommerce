...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><button onclick="goBack()"><span class="fa fa-arrow-circle-o-left"></span></button> Category 3 Create</h2>
        </div>
        <!-- END PAGE TITLE -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="block">
                        ...
                        <form id="jvalidate" role="form" method="post" class="form-horizontal" action="<?=root()?>/admin/master_data/category/category_2/category_3/store">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="name" placeholder="Enter Category 3 name" required/>
