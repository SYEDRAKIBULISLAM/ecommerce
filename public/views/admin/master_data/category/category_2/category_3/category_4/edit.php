...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><button onclick="goBack()"><span class="fa fa-arrow-circle-o-left"></span></button> Category 4 Edit </h2>
        </div>
        <!-- END PAGE TITLE -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="block">
                        ...
                        <form id="jvalidate" role="form" method="post" class="form-horizontal" action="<?=root()?>/admin/master_data/category/category_2/category_3/category_4/update/<?=$data['category4']->id?>">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control select" data-live-search="true" name="category_3_id" required>
                                            ...
                                            {
                                                if($item->id == $data['category4']->category3->id)
                                                {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?=$data['category4']->name;?>" name="name" placeholder="Enter Category 4 name"/>
